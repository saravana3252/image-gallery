function Header(props){
    return(
        <div className="w-full bg-black flex flex-col items-center p-2">
            <h1 id="logo" className="font-bold text-6xl text-white md:text-8xl">SUPERHERO</h1>
            <p className="text-white text-3xl pt-2 font-medium md:text-4xl">IMAGE GALLERY</p>
